...
export const DEEDS: Deed[] = [
  ...
  { id: "mill-ledger", title: "The Miller's Ledger", story: "Clerk Odo keeps the mill's ledger and his spelling wobbles. Spell each entry so the record stands.", buildingId: "mill", area: "language", questionCount: Q },
  ...
  { id: "chapel-scroll", title: "The Chapel Scroll", story: "Sister Wren found a faded scroll by the chapel door. Read its words aloud so she can copy them fresh.", buildingId: "chapel", area: "reading", questionCount: Q },
  ...
  { id: "library-catalog", title: "The Catalog", story: "Librarian Hesper is writing a card for every scroll. Read each name so the catalog is true.", buildingId: "library", area: "reading", questionCount: Q },
