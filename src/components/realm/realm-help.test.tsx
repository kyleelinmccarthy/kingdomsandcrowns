...
describe("helpGroups", () => {
  it("speaks keys to a keyboard hero and taps to a touch hero", () => {
    ...
    expect(keys[3].text).toBe("Pick a spell page (1, 2, 3, 4) or tap it, then click where the spell should go. Escape puts it away.");
    ...
    expect(touch[3].text).toBe("Tap a spell page, then tap where the spell should go, or tap Cast. Tap Put away when you are done.");
